...
class Place:
    ...
    def time_to(self, place_two):
        place_one_location = (self.location.x, self.location.y)
        place_two_location = (place_two.location.x, place_two.location.y)
    ...
    def get_places(characteristics):
        ...
        all_places = create_place(
            path, all_places, Category.beach, characteristics)

        path = 'NearbySearch/museums/'
        all_places = create_place(
            path, all_places,  Category.museums, characteristics)

        path = 'NearbySearch/nature/'
        all_places = create_place(
            path, all_places, Category.nature, characteristics)

        path = 'NearbySearch/night_clubs/'
        all_places = create_place(
            path, all_places, Category.club, characteristics)

        path = 'NearbySearch/bars/'
        all_places = create_place(
            path, all_places, Category.bar, characteristics)
        ...
        all_places = create_place(
            path, all_places, Category.shopping, characteristics)

        path = 'NearbySearch/cafeterias/'
        all_places = create_place(
            path, all_places, Category.cafe, characteristics)
    ...
    for i in results:
        ...
        for i in x['results']:
            ...
            if 'rating' in i:
                ...
                new_place = Place(name=name,  price=price_level,
                                  rating=rating,
